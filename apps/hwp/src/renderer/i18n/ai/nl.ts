...
export const nl = {
  ...
  aiToolReadDocument: 'Documenttekst lezen',
  aiToolReadSelection: 'Selectie lezen',
  aiToolListParagraphs: "Alinea's weergeven",
  aiToolListFields: 'Velden weergeven',
  aiToolListTables: 'Tabellen weergeven',

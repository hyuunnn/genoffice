...
export const ar = {
  ...
  aiToolReadDocument: 'قراءة نص المستند',
  aiToolReadSelection: 'قراءة التحديد',
  aiToolListParagraphs: 'سرد الفقرات',
  aiToolListFields: 'سرد الحقول',
  aiToolListTables: 'سرد الجداول',

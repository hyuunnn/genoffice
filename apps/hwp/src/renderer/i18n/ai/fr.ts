...
export const fr = {
  ...
  aiToolReadDocument: 'Lire le texte du document',
  aiToolReadSelection: 'Lire la sélection',
  aiToolListParagraphs: 'Lister les paragraphes',
  aiToolListFields: 'Lister les champs',
  aiToolListTables: 'Lister les tableaux',

...
export const hi = {
  ...
  aiToolReadDocument: 'दस्तावेज़ का पाठ पढ़ा',
  aiToolReadSelection: 'चयन पढ़ा',
  aiToolListParagraphs: 'अनुच्छेद सूचीबद्ध किए',
  aiToolListFields: 'फ़ील्ड सूचीबद्ध किए',
  aiToolListTables: 'तालिकाएँ सूचीबद्ध कीं',

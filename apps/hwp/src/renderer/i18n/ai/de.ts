...
export const de = {
  ...
  aiToolReadDocument: 'Dokumenttext lesen',
  aiToolReadSelection: 'Auswahl lesen',
  aiToolListParagraphs: 'Absätze auflisten',
  aiToolListFields: 'Felder auflisten',
  aiToolListTables: 'Tabellen auflisten',

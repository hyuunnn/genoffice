...
export const pl = {
  ...
  aiToolReadDocument: 'Odczytano tekst dokumentu',
  aiToolReadSelection: 'Odczytano zaznaczenie',
  aiToolListParagraphs: 'Wyświetlono listę akapitów',
  aiToolListFields: 'Wyświetlono listę pól',
  aiToolListTables: 'Wyświetlono listę tabel',
